<section class="section">
  <div class="container">
    <div class="box mb-6">
      <div class="table-container">
        <table class="table is-striped is-fullwidth is-size-7">
          <thead>
            <tr><th class="px-6 py-3 has-text-grey">Product ID</th><th class="px-6 py-3 has-text-grey">Title</th><th class="px-6 py-3 has-text-grey">Description</th><th class="px-6 py-3 has-text-grey">Gluten Free?</th><th class="px-6 py-3 has-text-grey">Meta Description</th><th class="px-6 py-3 has-text-grey">Action</th></tr>
          </thead>
          <tbody>
            
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                <td class="px-6 pt-5 pb-4"><?php echo e($product->id); ?></td>
                <td class="px-6 py-3">
                  <div class="is-flex is-align-items-center">
                    <img class="mr-4 image is-rounded is-cover is-32x32" src="https://vikalinka.com/wp-content/uploads/2020/02/Honey-Cake-Medovik-9-Edit.jpg" alt="Honey Cake">
                    <div>
                      <p class="has-text-weight-medium"><?php echo e($product->title); ?></p>
                    </div>
                  </div>
                </td>
                <td class="px-6 pt-5 pb-4"><?php echo e($product->description); ?></td>
                <td class="px-6 pt-5 pb-4">
                  <span class="tag is-success"><?php echo e($product->is_gluten_free ? 'Yes' : 'No'); ?></span>
                </td>
                <td class="px-6 pt-5 pb-4">
                  <span class="tag is-primary is-light"><?php echo e($product->meta_description); ?></span>
                </td>
                <td class="px-6 py-4">
                  <a class="button is-ghost p-0 mr-2" href="<?php echo e(route('admin.products.update', $product->id)); ?>">
                  ...
                  <button class="button is-ghost p-0 delete-size-button" data-size="<?php echo e(route('admin.products.delete', $product->id)); ?>">
    ...
    <div class="columns">
      <div class="column">
        <div class="is-flex is-align-items-center">
          <p class="is-size-7 has-text-grey-light">Show</p>
          <div class="select is-small mx-3">
            <select class="has-background-white" aria-label="Select example">
              <option value="1">9</option>
              <option value="2">18</option>
              <option value="3">36</option>
            </select>
          </div>
          <p class="is-size-7 has-text-grey-light">of 1200</p>
        </div>
      </div>
      ...
      <div class="column is-flex is-justify-content-flex-end">
        <nav class="pagination" role="navigation" aria-label="pagination">
          <ul class="pagination-list" style="font-size: 12px;">
            ...
            <li class="is-hidden-mobile"><a class="pagination-link has-background-white" href="#" aria-label="page 1">12</a></li>
            <li class="is-hidden-mobile"><a class="pagination-link has-background-white" href="#" aria-label="page 1">13</a></li>
            <li class="is-hidden-mobile"><a class="pagination-link has-background-white" href="#" aria-label="page 1">14</a></li>
            ...
            <li><a class="pagination-link has-background-white" href="#" aria-label="page 1">62</a></li>
            <li>
    ...
    <?php /**PATH /Users/zatokafamily/Documents/Code/projects/cakeshop/resources/views/admin/products/table.blade.php ENDPATH**/ ?>