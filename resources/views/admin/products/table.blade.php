        ...
        <table class="table is-striped is-fullwidth is-size-7">
          ...
          <tbody>
            ...
            @foreach($products as $product)
              <tr>
                <td class="px-6 pt-5 pb-4">{{ $product->id }}</td>
                <td class="px-6 py-3">
                  <div class="is-flex is-align-items-center">
                    ...
                    <div>
                      <p class="has-text-weight-medium">{{ $product->title }}</p>
                    </div>
                  </div>
                </td>
                <td class="px-6 pt-5 pb-4">{{ $product->description }}</td>
                <td class="px-6 pt-5 pb-4">
                  <span class="tag is-success">{{ $product->is_gluten_free ? 'Yes' : 'No' }}</span>
                </td>
                <td class="px-6 pt-5 pb-4">
                  <span class="tag is-primary is-light">{{ $product->meta_description }}</span>
                </td>
                <td class="px-6 py-4">
                  <a class="button is-ghost p-0 mr-2" href="{{ route('admin.products.update', $product->id) }}">
                  ...
                  <button class="button is-ghost p-0 delete-size-button" data-size="{{ route('admin.products.delete', $product->id) }}">
